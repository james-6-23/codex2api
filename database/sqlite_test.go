...
func TestSQLiteSystemSettingsPersistsFirstTokenTimeoutSeconds(t *testing.T) {
	...
	if settings.PromptFilterSemanticReviewFailurePolicy != "allow" {
		t.Fatalf("PromptFilterSemanticReviewFailurePolicy = %q, want allow", settings.PromptFilterSemanticReviewFailurePolicy)
	}
